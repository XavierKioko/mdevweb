    ...
    <table class="table table-bordered table-hover table-striped"><!--  table table-bordered table-hover Begin  -->
        ...
        <thead><!--  thead Begin  -->
            ...
            <tr><!--  tr Begin  -->
                ...
                <th> Easy Pesa, UBL, Mobi Cash Details: </th>
        ...
        <tbody><!--  tbody Begin  -->
           ...
           <td> Bank Name: UBL | Account No: 180-839-032 | Branch Name: Nairobi | Branch Code: 1498 </td>
           <td> NIC #980-231-907 | Mobile No: 0742284044 | Name: Mr Kioko </td>
           <td> Real Name: Mr Kioko | Mobile No: 0742284044 Country: Kenya | Name: Mr Kioko | NIC #980-231-907 </td>
